...
<a class="usa-button usa-button-primary" href="{{site.baseurl}}/assets/docs/US_Federal_Public_Trust_TLS_Certificate_Policy_v1_0.pdf" target="blank">Download PDF</a>
